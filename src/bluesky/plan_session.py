...
class PlanSession:
    ...
    def commands(self) -> dict[str, str]:
        ...
        whatever has been unregistered, in registration order: the built-ins as
        they are defined, then each command as it was registered. A command that
        carries no docstring maps to the empty string. Names and docstrings
        only: the callable a name resolves to is bound to the runner running the
        plan, and this session holds no runner to bind one to.
        """
